...
import { ExternalLink, Code } from "lucide-react"; // Code icon for default image
import { Tilt } from "react-tilt"; // React-Tilt for 3D effect
    ...
    <section className="relative w-full bg-[#0A0A0A] text-white py-20 overflow-hidden">
      ...
      >
        {projects.map((project, index) => (
          <Tilt key={project._id} options={{ max: 25, scale: 1.05, speed: 300 }}>
            <motion.div
